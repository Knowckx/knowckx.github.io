...
从去年 12 月开始，我开始尝试用 AI 工具做尽量少手动干预的全托管开发。目前经过 3 个多月的实践，量化交易项目也已经写了 3 万行，确实积累了一些心得，想整理出来分享一下。
...
原因很简单，AI 不像人，不能靠“记着点就行”硬扛。它每次进项目，本质上都要重新从文档和代码里找上下文。所以最重要的不是文档写得多，而是要起到**地图**的作用，做到**层次清楚，职责分开**。
...
总之，一份好的 AI 指导文档，核心的验收标准只有一个：让新窗口的大模型只靠**少量文档**，就能迅速掌握项目结构和核心业务。
...
> 偷偷说一句，我觉得我们这些码农，目前的新定位就是：人肉 `Harness`，也就是负责监督和兜底的那一层。
...
但它再强，也只是把工程师从低价值重复劳动里往外拉一点，真正的架构判断、边界控制和结果兜底，还是得人来做。

这四个心得，算是我目前最稳定的一套协作工作流总结。后面技术细节我会单独写一篇。
