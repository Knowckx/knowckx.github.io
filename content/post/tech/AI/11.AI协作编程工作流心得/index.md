...
原因很简单，AI 不像人，不能靠长期记忆掌握项目。每次打开一个新窗口进项目，本质上它都要重新从文档和代码里找上下文。所以最重要的就是有一份文档能起到**地图**的作用，并且做到**层次清楚，职责分开**。
...
让新窗口的大模型只靠**少量文档**，就能迅速掌握项目结构和核心业务。
...
> 原创声明：本文首发于我的个人博客 `https://blog.knowckx.de/`，未经授权请勿转载。
